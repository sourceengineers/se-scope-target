...
def main():
    command = "{\"payload\":{\"sc_cmd\":{\"cf_tgr\":{\"cl_id\":" + sys.argv[2] + ",\"mode\": \"" + sys.argv[3] + "\",\"level\": " + sys.argv[4] + ",\"edge\": \"" + sys.argv[5] + "\"}}}}\0";
...
def getCommand(id, mode, level, edge):
    command = "{\"payload\":{\"sc_cmd\":{\"cf_tgr\":{\"cl_id\":" + id + ",\"mode\": \"" + mode + "\",\"level\": " + level + ",\"edge\": \"" + edge + "\"}}}}\0";
    return command;
